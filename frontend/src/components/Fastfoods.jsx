      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-10 text-center">
          <div className="mb-4 flex justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-red-100 text-red-600 dark:bg-red-500/20 dark:text-red-400">
              <Pizza size={32} />
            </div>
          </div>
          ...
          <p className="mt-2 text-slate-500 dark:text-slate-400">
            Burgers, Pizza, Fries & more — quick & delicious
          </p>
        </div>
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative w-full max-w-md">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 bg-white py-3 pl-10 pr-4 text-sm outline-none focus:border-red-500 focus:ring-2 focus:ring-red-500/20 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
            />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border-2 border-dashed border-slate-200 py-20 text-center dark:border-slate-700">
            <Pizza size={48} className="mx-auto mb-4 text-slate-300" />
                ...
                <div className="p-5">
                  ...
                  {getQuantity(recipe._id) > 0 ? (
                    ...
                    <button
                      ...
                      className={`mt-4 w-full rounded-xl py-2.5 text-sm font-semibold transition ${recipe.isAvailable !== false ? "bg-red-500 text-white hover:bg-red-600" : "cursor-not-allowed bg-slate-200 text-slate-400 dark:bg-slate-700"}`}
                    >
