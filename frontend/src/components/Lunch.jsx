                ...
                <div className="p-5">
                  ...
                  {getQuantity(recipe._id) > 0 ? (
                    ...
                    <button
                      ...
                      className={`mt-4 w-full rounded-xl py-2.5 text-sm font-semibold transition ${recipe.isAvailable !== false ? "bg-orange-500 text-white hover:bg-orange-600" : "cursor-not-allowed bg-slate-200 text-slate-400 dark:bg-slate-700"}`}
                    >
